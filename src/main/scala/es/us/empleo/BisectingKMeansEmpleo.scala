...
@Since("1.6.0")
@Experimental
class BisectingKMeansEmpleo private (
                                      private var k: Int,
                                      private var maxIterations: Int,
                                      private var minDivisibleClusterSize: Double,
                                      private var seed: Long) extends Logging {

  import BisectingKMeansEmpleo._

  /**
    * Constructs with the default configuration
    */
  @Since("1.6.0")
  def this() = this(4, 20, 1.0, classOf[BisectingKMeansEmpleo].getName.##)
...
private object BisectingKMeansEmpleo extends Serializable {
